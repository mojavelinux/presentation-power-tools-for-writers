...
I believe documentation is an engineering problem, but in many cases it isn't being treated that way.
...
When you think of power tools for writing, what's the first thing that comes to mind.
Perhaps WYSIWYG?
...
The way I like to explain it is that the code you write doesn't run in production in raw form, but rather first packaged and often compiled.
